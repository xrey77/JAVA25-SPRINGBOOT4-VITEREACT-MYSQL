...
import com.java25.java25.springboot4.mysql.dto.MfaActivateDto;
...
import com.java25.java25.springboot4.mysql.services.TwoFactorAuthService;
	...
	public ResponseEntity<Map<String, String>> mfaActivate(@RequestBody MfaActivateDto mfaDto, @PathVariable Long id) {    	
		...
		if (user != null) {
	    	...
	    	if (mfaDto.isTwoFactorEnabled()) {
				...
				try {
					kafkaProducerService.sendEvent(KafkaEventType.ACTIVATE_MFA, map);
				} catch (Exception e) {
